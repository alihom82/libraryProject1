...
class User(AbstractUser):
    ...
    membership_date = models.DateField(auto_now_add=True, editable=False, verbose_name='تاریخ عضویت')
    wallet = models.IntegerField(default=0, null=False, blank=False, verbose_name='کیف پول')
